...
function update_data() {
  ...
  if (departmentCode === "" || departmentName === "" || departmentDivisionId === "") {
    Swal.fire({
      title: 'Error!',
      text: data.msg,
      icon: 'error',
    ...
    $.post('department/update_table', { id: id, departmentCode: departmentCode, departmentName: departmentName, departmentDivisionId: departmentDivisionId }, function (data) {
